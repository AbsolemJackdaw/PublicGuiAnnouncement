...
//
//@OnlyIn(Dist.CLIENT)
//public class RendererModelFlat extends ModelPart {
//
...
//                    bufferIn.vertex(vector4f.x(), vector4f.y(), vector4f.z(), red, green, blue, alpha, modelrenderer$positiontexturevertex.textureU,
